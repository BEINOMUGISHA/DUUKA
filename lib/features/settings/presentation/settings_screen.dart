...
class _SettingsScreenState extends ConsumerState<SettingsScreen> {
  ...
  void _showEditBusinessProfileDialog() {
    ...
    final bizNameCtrl = TextEditingController(text: session?.businessName ?? '');
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: const Row(
          children: [
            ...
            SizedBox(width: 10),
            Text('Edit Business Profile', style: TextStyle(fontWeight: FontWeight.w900, fontSize: 16)),
          ],
        ),
          ...
          child: Column(
            ...
            children: [
              TextField(
                ...
                decoration: const InputDecoration(labelText: 'Business / Shop Name *', prefixIcon: Icon(Icons.store)),
              ),
              const SizedBox(height: 10),
              TextField(
                controller: ownerNameCtrl,
                decoration: const InputDecoration(labelText: 'Owner / Manager Full Name *', prefixIcon: Icon(Icons.person)),
              ),
              const SizedBox(height: 10),
              TextField(
              ...
              TextField(
                ...
                decoration: const InputDecoration(labelText: 'URA Tax TIN', prefixIcon: Icon(Icons.account_balance)),
              ),
            ],
          ),
        ),
          ...
          ElevatedButton(
            onPressed: () {
              ...
              ref.read(authProvider.notifier).updateProfile(
                    ...
                    tin: tinCtrl.text.trim().isNotEmpty ? tinCtrl.text.trim() : null,
                  );
              Navigator.pop(ctx);
        ...
        builder: (ctx, setModalState) => AlertDialog(
          ...
          title: const Row(
            children: [
              ...
              SizedBox(width: 10),
              Text('Thermal Receipt Settings', style: TextStyle(fontWeight: FontWeight.w900, fontSize: 16)),
            ],
          ),
          content: Column(
            mainAxisSize: MainAxisSize.min,
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                items: const [
                  ...
                  DropdownMenuItem(value: '80mm (Standard Countertop)', child: Text('80mm (Standard Countertop)')),
                ],
                onChanged: (val) {
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                Navigator.pop(ctx);
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('✅ Thermal receipt settings saved!')),
                );
              },
  ...
  void _exportFullDatabaseBackup() async {
    ...
    Share.share(jsonStr, subject: 'DUKA_Backup_${DateTime.now().millisecondsSinceEpoch}.json');
  }
  ...
  Widget build(BuildContext context) {
    ...
    final currentBranch = branches.firstWhere((b) => b.id == selectedBranchId, orElse: () => branches.first);
                ...
                children: [
                  Row(
                    children: [
                      ...
                      IconButton(
                        icon: const Icon(Icons.edit_rounded, color: AppColors.primaryForest),
                  ...
                  _buildSettingRow(
                    ...
                    session?.isEfrisEnrolled == true ? 'Active (TIN: ${session?.tin ?? '1004928374'})' : 'Ready (TIN: 1004928374)',
                    isBadge: true,
          ...
          Card(
            ...
            child: ListTile(
              leading: Container(
                ...
                child: const Icon(Icons.store_rounded, color: Color(0xFF0284C7), size: 22),
              ),
              title: const Text('Active Store Branch', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
              subtitle: Text(
          ...
          Card(
            ...
            child: ListTile(
              leading: Container(
                ...
                child: const Icon(Icons.print_rounded, color: Color(0xFF059669), size: 22),
              ),
              title: const Text('Receipt & Thermal Printer Setup', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
              subtitle: Text(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildSettingRow('Staff Role', (session?.role ?? 'Owner').toUpperCase()),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  const Row(
                    children: [
                      Icon(Icons.save_rounded, color: Color(0xFF0F766E), size: 20),
                      SizedBox(width: 10),
                      Text('Database Backup & Export', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
                    ],
                  ),
                  const SizedBox(height: 6),
                  const Text(
                    ...
                    child: OutlinedButton.icon(
                      onPressed: () async {
                        ...
                        if (updateInfo != null) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text('✅ DUKA is up to date (Version 2.0.0)'),
                              backgroundColor: AppColors.success,
                            ),
                          );
                        }
