...
class _AuthScreenState extends ConsumerState<AuthScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(
        children: [
          const Positioned.fill(child: AuthCapitalFlowBackground()),
          Container(
                    ...
                    children: [
                      ...
                      const Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 10),
                          _BenefitCue(
                              icon: Icons.payments_rounded, label: 'Money'),
                        ],
                      ),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (_activeTab == 2) ...[
                              ...
                              const Text(
                                'Select a preconfigured role to instantly explore all DUUKA and UgaPOS capabilities:',
                                style: TextStyle(
                              ...
                              _buildDemoAccountCard(
                                ...
                                name: 'Grace Namubiru',
                                shop: 'DUUKA Branch 2 - Nakawa Market',
                                phone: '0788334455',
                                pin: '1234',
                      ...
                      Wrap(
                        ...
                        children: [
                          ...
                          _buildSecurityPill(Icons.verified_user_rounded,
                              'URA EFRIS Compliant'),
                        ],
                      ),
                    ],
